...
## Big Picture Mode — Game Controller
...
| Key | Action |
|---|---|
| **Page Up** / **Page Down** | Navigate between hex pages |
| **Go to Offset** | Jump to a specific hex address |
...
| Key | Action |
|---|---|
| **Sidebar items** | Click to navigate to each tool |
| **Native Menu** (macOS/Linux) | Access all tools via the platform menu bar |
