...
Each time you launch a ROM with RetroArch, the application increments a play counter for that ROM. The count is displayed in the detail panel as "Times played: N" and is persisted across sessions.

### Launching a ROM

Select a ROM card and press **Enter**, **Space**, or click the **Launch with RetroArch** button in the detail panel. The application:
