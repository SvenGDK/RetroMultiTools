...
public partial class ChecksumCalculatorView : UserControl
{
    ...
    {
        InitializeComponent();
        DragDropHelper.EnableFileDrop(FilePathTextBox, _ => CalculateButton.IsEnabled = true);
    }

    /// <summary>
    /// Pre-fills the file path and enables the calculate button.
    /// </summary>
    ...
    {
        var path = await PickFile(LocalizationManager.Instance["Common_SelectFileTitle"],
        [
