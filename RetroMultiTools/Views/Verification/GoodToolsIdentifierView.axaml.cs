...
namespace RetroMultiTools.Views.Verification;
...
public partial class GoodToolsIdentifierView : UserControl
{
    ...
    {
        InitializeComponent();
        DragDropHelper.EnableFileDrop(InputPathTextBox, _ => UpdateIdentifyButton(), acceptDirectories: true);
    }

    /// <summary>
    /// Pre-fills the input path and enables the identify button.
    /// </summary>
        ...
        try
        {
            ...
            if (isBatch)
            {
                ...
                foreach (var r in results)
                {
                    ...
                    {
                        sb.AppendLine("   " + LocalizationManager.Instance["GoodTools_NoCodesForFile"]);
                    }
                }
