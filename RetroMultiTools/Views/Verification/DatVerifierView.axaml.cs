...
public partial class DatVerifierView : UserControl
{
    ...
    {
        InitializeComponent();
        DragDropHelper.EnableFileDrop(DatFileTextBox, OnDatFileDropped);
        DragDropHelper.EnableFileDrop(RomInputTextBox, _ => UpdateVerifyButton(), acceptDirectories: true);
    }

    private void OnDatFileDropped(string path)
    {
