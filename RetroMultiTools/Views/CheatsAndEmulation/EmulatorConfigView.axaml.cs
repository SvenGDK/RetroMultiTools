...
using RetroMultiTools.Utilities.Emulation;
using RetroMultiTools.Utilities.RetroArch;

namespace RetroMultiTools.Views.CheatsAndEmulation;
...
public partial class EmulatorConfigView : UserControl
{
    ...
    public EmulatorConfigView()
    {
        ...
        DragDropHelper.EnableFileDrop(RomDirTextBox, acceptDirectories: true);
        DragDropHelper.EnableFileDrop(SaveDirTextBox, acceptDirectories: true);
        DragDropHelper.EnableFileDrop(StateDirTextBox, acceptDirectories: true);
        DragDropHelper.EnableFileDrop(ScreenshotDirTextBox, acceptDirectories: true);
        DragDropHelper.EnableFileDrop(OutputFileTextBox);
    }
