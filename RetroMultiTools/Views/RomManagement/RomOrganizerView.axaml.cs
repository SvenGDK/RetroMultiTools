...
public partial class RomOrganizerView : UserControl
{
    ...
    public RomOrganizerView()
    {
        ...
        SystemFilterComboBox.SelectionChanged += (_, _) => ApplyFilter();
        DragDropHelper.EnableFileDrop(SourcePathTextBox, _ =>
        {
            UpdateScanButtonState();
            ResetResults();
        }, acceptDirectories: true);
        DragDropHelper.EnableFileDrop(OutputPathTextBox, _ =>
        {
            UpdateScanButtonState();
    ...
    private void UpdateOrganizeButtonVisibility()
    {
        OrganizeButton.IsVisible = _scannedRoms is { Count: > 0 } &&
