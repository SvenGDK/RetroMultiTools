...
public partial class SnesHeaderToolView : UserControl
{
    ...
    {
        InitializeComponent();
        OutputFileTextBox.TextChanged += (_, _) => UpdateActionButtons();
    ...
    {
        bool hasOutput = !string.IsNullOrEmpty(OutputFileTextBox.Text);
        RemoveHeaderButton.IsEnabled = _hasCopierHeader && hasOutput;
        AddHeaderButton.IsEnabled = !_hasCopierHeader && hasOutput;
    }
